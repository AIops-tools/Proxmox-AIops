...
from proxmox_aiops.governance import READ_ONLY_ENV, is_read_only
...
def test_apply_read_only_unregisters_write_tools(monkeypatch):
    ...
    try:
        ...
        assert "vm_delete" in dropped and "vm_start" in dropped
        assert "vm_list" not in dropped and "vm_get" not in dropped

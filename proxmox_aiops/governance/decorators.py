...
from proxmox_aiops.governance.policy import get_policy_engine
...
def _record_undo(state: _CallState, result: Any) -> None:
    ...
    * **Undetermined** — the response was lost (see
      :mod:`proxmox_aiops.governance.outcome`). The change may be live,
...
def _infer_skill(func: Any) -> str:
    ...
    ``proxmox_aiops.ops.jobs`` → ``proxmox-aiops``
